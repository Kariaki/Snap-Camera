package com.choice.choicecamera.myfilters;
...
public  abstract class ChoiceBaseFilter extends BaseFilter {
    ...
    public ChoiceBaseFilter() {
        this(NO_FILTER_VERTEX_SHADER, NO_FILTER_FRAGMENT_SHADER);
    }

    public ChoiceBaseFilter(final String vertexShader, final String fragmentShader) {
